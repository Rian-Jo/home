  ...
  defaults:
    - scope:
      ...
      values:
        ...
        accent_image: "{{ site.baseurl }}/assets/img/hydejack-bg.jpg"
  ~~~
...
* When providing images to `image`, `image.path`, `image.src`, `image.srcset` and `accent_image `,
  ...
  e.g. values like `accent_image: {{ site.baseurl }}/assets/img/sidebar-bg.jpg` are now valid.
...
* Links to the `{{ site.baseurl }}/assets/` folder are no longer intercepted by the push state features,
...
~~~yml
image: {{ site.baseurl }}/hydejack/assets/img/nap.jpg
~~~
